...
cp /usr/lib/$(dpkg-architecture -q DEB_HOST_GNU_TYPE)/sasl2/libanonymous.so* ${PREFIX}/lib
cp /usr/lib/$(dpkg-architecture -q DEB_HOST_GNU_TYPE)/sasl2/libcrammd5.so* ${PREFIX}/lib
cp /usr/lib/$(dpkg-architecture -q DEB_HOST_GNU_TYPE)/sasl2/libdigestmd5.so* ${PREFIX}/lib
cp /usr/lib/$(dpkg-architecture -q DEB_HOST_GNU_TYPE)/sasl2/liblogin.so* ${PREFIX}/lib
cp /usr/lib/$(dpkg-architecture -q DEB_HOST_GNU_TYPE)/sasl2/libntlm.so* ${PREFIX}/lib
cp /usr/lib/$(dpkg-architecture -q DEB_HOST_GNU_TYPE)/sasl2/libplain.so* ${PREFIX}/lib
